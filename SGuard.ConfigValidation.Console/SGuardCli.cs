...
namespace SGuard.ConfigValidation.Console;
...
public sealed class SGuardCli
{
    ...
    private RootCommand CreateRootCommand()
    {
        ...
        var rootCommand = new RootCommand("SGuard ConfigValidation - A lightweight tool to catch critical configuration issues before runtime")
        {
            validateCommand
        };
