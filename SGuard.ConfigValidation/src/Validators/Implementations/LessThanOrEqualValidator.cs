...
public sealed class LessThanOrEqualValidator : BaseValidator<object>
{
    public override string ValidatorType => "lte";
    
    // LessThanOrEqual validator works with numeric values
