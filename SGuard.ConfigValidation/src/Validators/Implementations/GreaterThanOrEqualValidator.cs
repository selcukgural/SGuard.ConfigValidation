...
public sealed class GreaterThanOrEqualValidator : BaseValidator<object>
{
    public override string ValidatorType => "gte";
    
    // GreaterThanOrEqual validator works with numeric values
