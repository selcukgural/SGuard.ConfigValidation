...
public sealed class SecurityOptions
{
    ...
    /// </summary>
    public long StreamingThresholdBytes { get; set; } = SecurityConstants.StreamingThresholdBytes;
    ...
    public bool ValidateAndClamp(ILogger? logger = null)
    {
        ...
        if (StreamingThresholdBytes > SecurityConstants.StreamingThresholdBytesHardLimit)
        {
            logger?.LogWarning(
                "Security option 'StreamingThresholdBytes' ({Value} bytes) exceeds hard limit ({HardLimit} bytes). Clamping to hard limit.",
                StreamingThresholdBytes, SecurityConstants.StreamingThresholdBytesHardLimit);
            StreamingThresholdBytes = SecurityConstants.StreamingThresholdBytesHardLimit;
            clamped = true;
        }
