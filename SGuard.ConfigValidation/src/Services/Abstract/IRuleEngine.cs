...
public interface IRuleEngine
{
    ...
    Task<RuleEngineResult> ValidateEnvironmentAsync(string configPath, string environmentId, CancellationToken cancellationToken = default);
    ...
    Task<RuleEngineResult> ValidateAllEnvironmentsAsync(string configPath, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">Optional cancellation token to cancel the operation.</param>
    /// <returns>A task that represents the asynchronous operation. The task result contains a rule engine result with the validation results.</returns>
    Task<RuleEngineResult> ValidateEnvironmentFromJsonAsync(string configJson, string environmentId, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">Optional cancellation token to cancel the operation.</param>
    /// <returns>A task that represents the asynchronous operation. The task result contains a rule engine result with validation results for all environments.</returns>
    Task<RuleEngineResult> ValidateAllEnvironmentsFromJsonAsync(string configJson, CancellationToken cancellationToken = default);
}
