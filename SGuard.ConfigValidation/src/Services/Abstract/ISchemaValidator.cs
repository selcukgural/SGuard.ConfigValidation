...
public interface ISchemaValidator
{
    ...
    Task<SchemaValidationResult> ValidateAsync(string jsonContent, string schemaContent);
    ...
    /// <returns>A task that represents the asynchronous validation operation. The task result contains the validation result with any errors found.</returns>
    Task<SchemaValidationResult> ValidateAgainstFileAsync(string jsonContent, string schemaPath);
}
