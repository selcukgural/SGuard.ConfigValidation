...
public interface IConfigLoader
{
    ...
    Task<SGuardConfig> LoadConfigAsync(string configPath, CancellationToken cancellationToken = default);
    ...
    Task<Dictionary<string, object>> LoadAppSettingsAsync(string appSettingsPath, CancellationToken cancellationToken = default);
}
