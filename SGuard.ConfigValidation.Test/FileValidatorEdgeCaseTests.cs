...
public sealed class FileValidatorEdgeCaseTests
{
    ...
    [Fact]
    public async Task ValidateFileAsync_With_CancellationToken_Should_RespectCancellation()
    {
        // Arrange
        var rules = new List<Rule>
        {
        ...
        await Assert.ThrowsAsync<OperationCanceledException>(async () =>
            await _fileValidator.ValidateFileAsync("test.json", rules, appSettings, cts.Token));
    }

    [Fact]
    public async Task ValidateFileAsync_With_ValidInput_Should_ReturnResult()
    {
        // Arrange
        var rules = new List<Rule>
        {
        ...
        // Act
        var result = await _fileValidator.ValidateFileAsync("test.json", rules, appSettings);
    ...
    [Fact]
    public async Task ValidateFileAsync_With_NullRule_Should_AddFailureResult()
    {
        // Arrange
        var rules = new List<Rule> { null! };
        var appSettings = new Dictionary<string, object>();
    ...
    [Fact]
    public async Task ValidateFileAsync_With_EmptyRuleId_Should_AddFailureResult()
    {
        // Arrange
        var rules = new List<Rule>
        {
